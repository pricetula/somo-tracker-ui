...
export function SchoolSwitcher() {
    ...
    const handleSchoolClicked = React.useCallback((school: School) => console.log(school), []);
            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <Avatar>
                                <AvatarFallback className="border-none bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg">
                                    {initialSchoolName}
                                </AvatarFallback>
                            </Avatar>
