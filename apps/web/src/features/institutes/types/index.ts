...
export type AddInstituteRequest =
    components["schemas"]["internal_institute_delivery_http.addInstituteInput"];
export type UpdateInstituteRequest =
    components["schemas"]["internal_institute_delivery_http.updateInstituteInput"];
