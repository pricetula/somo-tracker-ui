...
<section class="py-28 px-4 bg-muted/30" use:inView onenter={onEnter}>
  <div class="max-w-6xl mx-auto">
    <p
      class="text-center text-sm font-semibold uppercase tracking-widest text-muted-foreground mb-4"
    >
    ...
    {#if visible}
      <div class="grid md:grid-cols-3 gap-8" in:fly={{ y: 30, duration: 600 }}>
        <Card
          class="p-8 text-center hover:shadow-lg hover:border-destructive/30 transition-all duration-300"
        >
          <CardContent class="p-0 space-y-4">
            <div
              class="w-16 h-16 mx-auto rounded-2xl bg-destructive/10 flex items-center justify-center"
            >
            ...
            <p class="text-muted-foreground">
              Lost to manual grading & test prep
            </p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent class="p-0 space-y-4">
            ...
            <p class="text-muted-foreground">
              Spent on printing, storage, disposal
            </p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent class="p-0 space-y-4">
            ...
            <p class="text-muted-foreground">
              Before at-risk students get help
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <p
        class="text-center mt-12 text-xl text-muted-foreground italic"
