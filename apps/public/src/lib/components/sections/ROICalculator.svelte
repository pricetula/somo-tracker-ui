                ...
                <CardContent class="space-y-8 p-0">
                    ...
                    <div class="grid md:grid-cols-3 gap-6 text-center">
                        <div class="space-y-2 metric-item">
                            ...
                            <p
                                class="text-3xl font-bold font-mono text-red-400"
                            >
                                *KSh {Math.round(
                                    $annualPrintingSaved,
                                ).toLocaleString()}
                        ...
                        <div
                            class="space-y-2 border-x border-muted metric-item"
                        ...
                        >
                            ...
                            <p
                                class="text-3xl font-bold font-mono text-primary"
                            >
                                {Math.round(
                                    $annualMarkingHours,
                                ).toLocaleString()}
                        ...
                        >
                            ...
                            <p
                                class="text-3xl font-bold font-mono text-green-600"
                            >
                                92%
                            </p>
                            <p class="text-xs text-muted-foreground">
                    ...
                    <div class="flex flex-col items-center space-y-4 mt-20">
